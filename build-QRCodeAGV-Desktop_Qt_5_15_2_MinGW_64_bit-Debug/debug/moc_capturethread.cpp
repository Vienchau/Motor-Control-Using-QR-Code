...
#include <memory>
#include "../../QRCodeAGV_SW/capturethread.h"
...
QT_MOC_LITERAL(1, 14, 12), // "frameCapture"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "cv::Mat*"
QT_MOC_LITERAL(4, 37, 4) // "data"

    },
    "CaptureThread\0frameCapture\0\0cv::Mat*\0"
    "data"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->frameCapture((*reinterpret_cast< cv::Mat*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::frameCapture)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureThread::frameCapture(cv::Mat * _t1)
{
